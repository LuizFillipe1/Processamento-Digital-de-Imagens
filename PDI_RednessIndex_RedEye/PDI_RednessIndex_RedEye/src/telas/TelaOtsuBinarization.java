 ...
 */
public class TelaOtsuBinarization extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Binarização Otsu para Imagens de uma Pasta");
	...
	private void btnSelPastaOrigemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelPastaOrigemActionPerformed
		...
		try{
			...
			Logger.getLogger(TelaOtsuBinarization.class.getName()).log(Level.SEVERE, null, ex);
		}  
...
//								BufferedImage imagemProcessada = ProcessamentoImagem.riRedPlant(imgOriginal);
								BufferedImage imagemBinarizada = ProcessamentoImagem.OtsuBinarization(imgOriginal); 

								File fo = new File(pastaDestino.getPath()+"/"+arqPastaOrigem.getName().substring(0, arqPastaOrigem.getName().length() - 4)+"_OTSU"+".png");
	...
	public static void main(String args[]) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new TelaOtsuBinarization().setVisible(true);
			}
		});
	}
