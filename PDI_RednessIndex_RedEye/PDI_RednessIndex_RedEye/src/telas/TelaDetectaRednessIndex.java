 ...
 */
public class TelaDetectaRednessIndex extends javax.swing.JFrame {
     ...
     */
    public TelaDetectaRednessIndex() {        
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Detectar Redness Index em Imagens de uma Pasta");
    ...
    private void btnSelPastaOrigemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelPastaOrigemActionPerformed
        ...
        try{
            ...
            Logger.getLogger(TelaDetectaRednessIndex.class.getName()).log(Level.SEVERE, null, ex);
        }  
                    ...
                    for(File arqPastaOrigem: pastaOrigem.listFiles()){
                          ...
                          (btnBmpOption.isSelected() && arqPastaOrigem.getName().toLowerCase().endsWith(".bmp")))
                        {
                            try {
                                ...
                                BufferedImage imagemProcessada = ProcessamentoImagem.riRedEye(imgOriginal);
                                File fo = new File(pastaDestino.getPath()+"/"+arqPastaOrigem.getName().substring(0, arqPastaOrigem.getName().length() - 4)+"_RedLuo2"+".png");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDetectaRednessIndex.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaDetectaRednessIndex().setVisible(true);
            }
        });
    }
