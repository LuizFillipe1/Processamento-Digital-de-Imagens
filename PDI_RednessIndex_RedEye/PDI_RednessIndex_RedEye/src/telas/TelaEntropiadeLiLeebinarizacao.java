...
public class TelaEntropiadeLiLeebinarizacao extends javax.swing.JFrame {
	 ...
	 */
	public TelaEntropiadeLiLeebinarizacao() {        
		initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("ENTROPIA DE LILEE");
        setFocusCycleRoot(false);
        setResizable(false);

        jLabel1.setFont(new java.awt.Font("Ubuntu", 1, 20)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Binarização Entropia de LiLee para Imagens de uma Pasta");
        ...
        btnPngOption.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPngOptionActionPerformed(evt);
            }
        });
	...
	private void btnSelPastaOrigemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelPastaOrigemActionPerformed
		...
		try{
			...
			Logger.getLogger(TelaEntropiadeLiLeebinarizacao.class.getName()).log(Level.SEVERE, null, ex);
		}  
...
//								BufferedImage imagemProcessada = ProcessamentoImagem.riRedPlant(imgOriginal);
								BufferedImage imagemBinarizada = ProcessamentoImagem.BinarizacaoEntropiaLiLee(imgOriginal); 

								File fo = new File(pastaDestino.getPath()+"/"+arqPastaOrigem.getName().substring(0, arqPastaOrigem.getName().length() - 4)+"_BinLiLee"+".png");
								ImageIO.write(imagemBinarizada, "png", fo);
								numImgsProcessadas++;                                
    ...
    private void btnPngOptionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPngOptionActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnPngOptionActionPerformed
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(TelaOtsuBinarization.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new TelaEntropiadeLiLeebinarizacao().setVisible(true);
			}
		});
	}
